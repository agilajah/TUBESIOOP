...
bool Elang::isSameDirection(int temp){
	...
	//korelasi arah :
	if (((temp==1 || temp==5 || temp==6) && (arah==1 || arah==5 || arah==6)) || //// dinding kanan 	: 1, 5, 6
		((temp==3 || temp==7 || temp==8) && (arah==3 || arah==7 || arah==8)) || //// dinding kiri	: 3, 7, 8
		((temp==2 || temp==5 || temp==6) && (arah==2 || arah==5 || arah==6)) || //// dinding atas 	: 2, 5, 6
		((temp==4 || temp==6 || temp==8) && (arah==4 || arah==6 || arah==8)) ) //// dinding bawah 	: 4, 6, 8	
		return true;
	else
		return false;
}
